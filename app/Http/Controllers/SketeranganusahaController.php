...
class SketeranganusahaController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('surat.indexsketeranganusaha', compact('penduduk'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $surat = surat::where('tipe_surat', "Keterangan Usaha")->latest('no_surat')->first();
        ...
        return view('template.templateketeranganusaha', [
            'nama_warga' => $detailWarga->nama,
            'tempat_lahir' => $request->tempat_lahir,
            // 'no_surat' => $surat->no_surat + 1,
            'tanggal_lahir' => $request->tanggal_lahir,
    ...
    public function getDataPenduduk(Request $request)
    {
        ...
        $data['status'] = 'ok';
        $data['result'] = array('jeniskelamin' => $penduduk->jenis_kelamin, 'alamat' => $penduduk->alamat, 'nik' => $penduduk->nik, 'kewarganegaraan' => $penduduk->kewarganegaraan,
