...
class SketeranganController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('surat.indexsketerangan', compact('penduduk'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $surat = surat::where('tipe_surat', "Keterangan")->latest('no_surat')->first();
        ...
        return view('template.templateketerangan', [
            'nama_warga' => $detailWarga->nama,
            'tempat_lahir' => $request->tempat_lahir,
            // 'no_surat' => $surat->no_surat + 1,
            'tanggal_lahir' => $request->tanggal_lahir,
    ...
    public function getDataPenduduk(Request $request)
    {
        ...
        'pendidikan' => $penduduk->pendidikan, 'agama' => $penduduk->agama,
