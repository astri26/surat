              ...
              <div class="card-body">
                <form method="POST" action="{{ route('login') }}" class="needs-validation" novalidate="">
                  ...
                  <div class="form-group">
                    ...
                    <input  id="username"  type="text" class="form-control @error('username') is-invalid @enderror" autocomplete="off"  name="username" value="{{ old('username') }}" tabindex="1" required autofocus>
                    @error('username')
                  ...
                  <div class="form-group">
                    <div class="d-block">
                      <label for="password_2" class="control-label">{{ __('Password') }}</label>

                    </div>
                    <input id="password_2" type="password" class="form-control" autocomplete="off" @error('password') is-invalid @enderror name="password" tabindex="2" required>
