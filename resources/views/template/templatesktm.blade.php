...
<body>
    <div id=halaman>
        ...
        <p  style="text-align: justify; text-indent: 0.5in;" >Bahwa nama yang tercantum diatas adalah warga Desa Bibrik Kecamatan Jiwan Kabupaten Madiun. Sesuai data yang ada di Kantor Desa orang tersebut diatas benar keluarga kurang mampu <b><i>(KELUARGA BERPENGHASILAN RENDAH)</i></b>.
			Dengan penghasilan sebesar {{$penghasilan ?? ''}}. Dan Surat Keterangan ini diberikan untuk persyaratan {{$keterangan ?? ''}}.</p>
