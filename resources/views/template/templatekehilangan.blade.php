...
<head>
	...
	<body bgcolor="white">
		...
		<font face="Times New Roman" color="black" size="4">
			<p align="center"> <u> <b> SURAT KETERANGAN KEHILANGAN </b></u>
		</font>
		<br>
    ...
    <div id=halaman>
        ...
        <table>
            ...
            <tr>
                ...
                <td style="width: 5%;">:</td>
                <td style="width: 65%;"> Orang tersebut Telah kehilangan {{$keterangan ?? ''}}</td>
            </tr>
        </table>

        <p  style="text-align: justify; text-indent: 0.5in;" >Demikian Surat Keterangan ini diberikan untuk dipergunakan sebagaimana mestinya.</i></p>
