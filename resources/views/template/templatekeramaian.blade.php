...
<head>
	...
	<body bgcolor="white">
		...
		<font face="Times New Roman" color="black" size="4">
			<p align="center"> <u> <b> SURAT IZIN KERAMAIAN </b></u>
		</font>
		<br>
		<font face="Times New Roman" color="black" size="2">  Nomor : 470/{{ $no_surat ?? '' }}/401.406.02/2021 </font>
            ...
            <body>
                <div id=halaman>
                    ...
                    <p  style="text-align: justify; text-indent: 0.5in;" >Orang tersebut diatas benar-benar penduduk Desa Bibrik dan surat pemberitahuan keramaian ini digunakan untuk {{$keterangan ?? ''}}.
                        </i></p>
                    <p  style="text-align: justify; text-indent: 0.5in;" >Demikian surat pemberitahuan keramaian ini dibuat dan dapat dipergunakan sebagaimana mestinya.
                        </i></p>
                        @php
                        $bulan = array (
                            1 =>   'Januari',
                    ...
                    @endphp
        <div style="width:39%; text-align: center; float: right;">Bibrik, {{ Carbon\Carbon::parse($tanggal ?? '')->translatedFormat('d F Y') }}</div><br>
