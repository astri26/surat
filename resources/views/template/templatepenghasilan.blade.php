...
<head>
	...
	<body bgcolor="white">
		...
		<font face="Times New Roman" color="black" size="4">
			<p align="center"> <u> <b> SURAT KETERANGAN PENGHASILAN </b></u>
		</font>
		<br>
            ...
            <body>
                <div id=halaman>
                    ...
                    <table>
                        ...
                        <tr>
                            <td style="width: 30%; vertical-align: top;">Keterangan Lain</td>
                            <td style="width: 5%; vertical-align: top;">:</td>
                        </table>
                            <p  style="text-align: justify; text-indent: 0.5in;" > Benar nama yang tercantum diatas adalah warga Desa Bibrik Kecamatan
                                Jiwan Kabupaten Madiun. Dengan sepengetahuan kami dan sesuai data
                                yang ada di Kantor Desa orang tersebut diatas benar keluarga Tidak
                                mampu (KELUARGA BERPENGHASILAN RENDAH) dengan
                                penghasilan per bulan {{$penghasilan ?? ''}}.</td>
                        </tr>
                        <tr>
                            <td style="width: 30%; vertical-align: top;">Surat ini Digunakan</td>
                            <td style="width: 5%; vertical-align: top;">:</td>
                            <td style="width: 65%;">Untuk {{$keperluan ?? ''}}</td>
                        </tr>

                    <p  style="text-align: justify; text-indent: 0.5in;" >Demikian Surat Keterangan ini diberikan untuk dipergunakan sebagaimana mestinya.
                        </i></p>
                        @php
                        $bulan = array (
                            1 =>   'Januari',
