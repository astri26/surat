        ...
        <div class="row">
            ...
            <div class="card">
                <div class="card-header">
                    <h4>Cetak Surat Kematian</h4>
                </div>
                <div class="card-body">
                <form action="{{url('/skematian')}}" method="post">
                    @csrf
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                            <input type="text" disabled class="form-control" id="jenis_kelamin" name="jenis_kelamin" placeholder="Jenis Kelamin" required>
                        </div>
                    </div>
                    <div class="form-group row mb-4">
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                            <input type="date" class="form-control" id="tanggal_meninggal" name="tanggal_meninggal" placeholder="Tanggal" required>
                        </div>
                    </div>
                    <div class="form-group row mb-4">
                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Di</label>
                        <div class="col-sm-12 col-md-7">
                            <input type="text" class="form-control" id="lokasi" name="lokasi" placeholder="Lokasi Meninggal" required>
                        </div>
                    </div>
                    <div class="form-group row mb-4">
                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Disebabkan</label>
                        <div class="col-sm-12 col-md-7">
                            <input type="text" class="form-control" id="keterangan" name="keterangan" placeholder="Disebabkan" required>
                        </div>
                    </div>
                    </div>
                    <div class="form-group row mb-4">
