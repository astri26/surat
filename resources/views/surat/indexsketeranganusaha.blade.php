        ...
        <div class="row">
            ...
            <div class="card">
                <div class="card-header">
                    <h4>Cetak Surat Keterangan Usaha</h4>
                </div>
                <div class="card-body">
                <form action="" method="post">
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                            <input type="text" class="form-control" disabled class="form-control" id="jeniskelamin" name="jeniskelamin" placeholder="Jenis Kelamin" required>
                        </div>
                    </div>
                        <div class="form-group row mb-4">
                    ...
                    <div class="form-group row mb-4">
                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Usaha</label>
                        <div class="col-sm-12 col-md-7">
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                            <input type="text" class="form-control" id="keperluan" name="keperluan" placeholder="Keterangan" required>
                        </div>
                    </div>
                    </div>
                    <div class="form-group row mb-4">
...
<script type="text/javascript">
    function setInput(result) {
        ...
        $.ajax({
            url: '{{ url('/sketeranganusaha/get-data/') }}',
            type: 'post',
            data: '_token={{ csrf_token() }}&id=' + value,
            dataType: 'JSON',
            success: function(response){
                document.getElementById('jeniskelamin').value = response.result.jeniskelamin;
